...
Observed. 2026-09-11T201041Z UTC
Git SHA. `96d88cc27875488d98c10fa52b293477cfdf9420`
Source report. `research/evals/results/2026-09-11T201041Z-96d88cc2.json`
...
| `graphiti` | 0/9 | 1603 | 472512 | Graphiti temporal graph |
...
| `graphiti` | skip | FAIL | FAIL | skip | FAIL | FAIL | FAIL | FAIL | FAIL |
...
- **Graphiti scores 0/9** on this harness (Kiro extract + hybrid search). Two heavy fixtures skipped on malformed JSON from the gateway; the rest fail companion write/read policy holes (joke-as-fact, forget-that, reunion gap, etc.). Wall time ~26x companmem.
